...
public class Helper {
    ...
    public static void main(String[] args) throws IOException{
        ...
        BufferedReader pr = new BufferedReader(new FileReader("src/main/java/pr.txt"));
        BufferedReader transition = new BufferedReader(new FileReader("src/main/java/transition.txt"));
        FileWriter fileWriter = new FileWriter("src/main/java/output.cvs");
